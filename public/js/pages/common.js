...
(function () {
  ...
  async function mountReport(containerEl, reportData) {
    if (!containerEl || !window.ReportRenderer) return;
    await window.ReportRenderer.renderReport(reportData, containerEl);
  }
